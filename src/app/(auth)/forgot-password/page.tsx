    ...
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-zinc-100 p-7 shadow-sm">
          ...
          <p className="text-sm text-zinc-400 mb-6">Masukkan email Anda untuk mereset password.</p>
          ...
          <form action={resetPasswordForEmail} className="space-y-4">
            ...
            <SubmitButton pendingText="Mengirim..." className="w-full h-10 bg-zinc-900 hover:bg-zinc-800 text-white rounded-lg text-sm font-medium transition-all shadow-sm">
              Kirim Link Reset
            </SubmitButton>
          </form>
        </div>
