import { signup, loginWithGoogle } from '@/actions/auth.actions'
    ...
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-zinc-100 p-7 shadow-sm">
          <h1 className="text-xl font-semibold text-zinc-900 mb-1">Buat Akun</h1>
          <p className="text-sm text-zinc-400 mb-6">Mulai berjualan hari ini, gratis.</p>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-zinc-400">atau dengan email</span>
            <div className="flex-1 h-px bg-zinc-100"></div>
          </div>
          ...
          <form action={signup} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="full_name" className="text-xs font-medium text-zinc-700">Nama Lengkap</Label>
              <Input
                id="full_name"
                name="full_name"
                type="text"
        ...
        <p className="text-center text-xs text-zinc-400 mt-4">
          Sudah punya akun?{' '}
          <Link href="/login" className="text-zinc-700 hover:text-zinc-900 font-medium transition-colors">
            Masuk di sini
          </Link>
        </p>
      </div>
