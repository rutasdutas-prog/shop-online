...
export default async function StorefrontPage(
  ...
  // Helper: build Instagram URL (supports full URL or plain username)
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs">
                ...
                {settings.tiktok && (
                  <a href={settings.tiktok} target="_blank"
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-white/60 border border-white/10 hover:border-white/20 transition-all"
                    style={{ backgroundColor: 'rgba(255,255,255,0.06)' }}>
                    <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v8.12c0 1.93-.89 3.73-2.31 4.96-1.42 1.23-3.23 1.86-5.11 1.8-1.89-.07-3.7-1.02-4.9-2.5-1.2-1.48-1.74-3.35-1.52-5.24.23-1.89 1.15-3.6 2.5-4.8 1.35-1.2 3.12-1.8 5.01-1.66V13c-1.28-.1-2.58.42-3.41 1.4-.82.98-1.07 2.34-.63 3.55.43 1.21 1.52 2.15 2.8 2.38 1.28.24 2.6-.14 3.48-1.07.88-.93 1.29-2.22 1.1-3.5V0h-1.09z"/></svg>
                    TikTok
                  </a>
                )}
