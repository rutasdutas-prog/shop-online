                ...
                <StaggerItem key={product.id}>
                  <div className={`group bg-white ${cornerStyle} overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-zinc-100 flex flex-col h-full relative ${isOutOfStock ? 'opacity-70' : ''}`}>
                    ...
                    <div className="aspect-[4/5] bg-zinc-50 relative overflow-hidden">
                      ...
                      {/* Overlay CTA Desktop - show only for non-variant products */}
                      {!isOutOfStock && !hasVariants && (
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hidden lg:flex items-center justify-center backdrop-blur-[2px]">
                          {store.whatsapp ? (
                            <a
